...
def get_metascore(gamename):
    ...
    page = "https://www.metacritic.com/search/game/"+gamename+"/results?plats[7]=1&search_type=advanced" #10- PSX 7- PSP
    ...
    try:
        ...
        if metascore == "tbd":
            ...
            print(gamename,"has a score of >>",metascore,"<<")
            fileWithScores = open("metaScores-PSP.txt","a+")
            print(gamename,metascore,file=fileWithScores)
...
readFromFileIntoArray("pspGames.txt")
